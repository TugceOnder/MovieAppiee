...
namespace MovieAppie.WebApi.Controllers
{
    ...
    public class MoviesController : ControllerBase
    {
        ...
        public MoviesController(GetMovieByIdQueryHandler getMovieByIdQueryHandler, GetMovieQueryHandler getMovieQueryHandler, 
        ...
        public  async Task<IActionResult>DeleteMovie(int id)
        {
            ...
            return Ok("Film silme işlem başarılı");
        }
        ...
        {
            await _updateMovieCommandHandler.Handle(command); return Ok("film Güncelleme işlemi tamamlandı");
        }
    }
}
